...
#'       
#'    2. the name of the column within the fact table that contains the relevant
#'       concept_ids (i.e. measurement_concept_id, condition_source_concept_id, etc.)
#'       
#'    3. a codeset that contains or is filtered down to codes for the concept of interest
#'    
#'    4. a string identifier for the check, prefixed with the check name like `ecp_*` 
#'
